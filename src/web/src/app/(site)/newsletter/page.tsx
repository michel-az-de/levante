...
export default function NewsletterPage() {
  ...
  return (
    <div className="mx-auto flex min-h-[70vh] max-w-2xl flex-col justify-center gap-6 px-6 py-16">
      ...
      {habilitada ? (
        ...
        <p className="text-site-fg2">A newsletter estara disponivel em breve. Volte logo.</p>
      )}
    </div>
  );
}
