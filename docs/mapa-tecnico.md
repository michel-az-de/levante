...
| Mediator | GAP | GAP-F: MediatR / Wolverine / hand-rolled |
...
| Contrato com Hiram | GAP | GAP-I: como o Hiram consome hoje |
...
|--------|----------|-------|
| MediatR | comercial em versões novas | hand-rolled leve / Wolverine |
